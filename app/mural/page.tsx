...
import { 
  ...
  User, Users, Sparkles, ChevronLeft, Loader2, Video, Camera 
} from "lucide-react";
...
export default function MuralMembros() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-[#F8F9FA] pb-32 overflow-x-hidden">
      ...
      {/* RODAPÉ DE NAVEGAÇÃO PADRONIZADO (4 BOTÕES) */}
      <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[95%] max-w-[380px] bg-ibac-dark rounded-full py-3 px-6 flex justify-between items-center shadow-2xl z-50">
        ...
        {/* Mural (Ativo) */}
        <Link href="/mural" className="text-ibac-orange flex flex-col items-center flex-1">
            <Users size={20} />
